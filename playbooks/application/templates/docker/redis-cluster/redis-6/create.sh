...
docker run --init -d \
           ...
           -v "{{docker_files_path}}/redis-cluster/redis-6/data:/data" \
           -v "{{docker_files_path}}/redis-cluster/redis-6/config/redis.conf:/opt/bitnami/redis/mounted-etc/redis.conf:ro" \
